...
url = 'https://www.stockwatch.com/Quote/WebQuery.aspx?what=quote&format=comma&fields=SXRLVOHITE&pf=4&region=C&header=Y' # works
...
#  response = urllib2.urlopen(req)
  ...
  print "Done updatePortfolio4Stockwatch.py"