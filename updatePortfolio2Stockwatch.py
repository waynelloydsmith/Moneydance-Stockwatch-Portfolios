...
url = 'https://www.stockwatch.com/Quote/WebQuery.aspx?what=quote&format=comma&fields=SXRLVOHITE&pf=2&region=C&header=Y' # works
...
#  response = urllib2.urlopen(req)
  ...
  print "Done updatePortfolio2Stockwatch.py"